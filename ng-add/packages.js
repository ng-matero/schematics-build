...
function addKeyPkgsToPackageJson(host) {
    package_config_1.addPackage(host, '@angular/cdk@~9.2.4');
...
function add3rdPkgsToPackageJson(host) {
    package_config_1.addPackage(host, '@angular/material@~9.2.4');
    package_config_1.addPackage(host, '@angular/flex-layout@^9.0.0-beta.31');
    // 3rd lib
    package_config_1.addPackage(host, '@ng-matero/extensions@^9.6.0');
    package_config_1.addPackage(host, '@ng-select/ng-select@^4.0.4');
    package_config_1.addPackage(host, '@ngx-formly/core@^5.8.0');
    package_config_1.addPackage(host, '@ngx-formly/material@^5.8.0');
    ...
    package_config_1.addPackage(host, 'ngx-progressbar@^6.0.3');
    package_config_1.addPackage(host, 'ngx-toastr@^12.1.0');
