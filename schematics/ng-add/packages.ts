...
export function add3rdPkgsToPackageJson(host: Tree, options: Schema) {
  ...
  // 3rd lib
  addPackage(host, '@ng-matero/extensions@^0.4.0');
  addPackage(host, '@ng-select/ng-select@^3.6.1');
  addPackage(host, '@ngx-formly/core@^5.5.5');
  addPackage(host, '@ngx-formly/material@^5.5.5');
  ...
  addPackage(host, 'ngx-toastr@^11.2.1');
