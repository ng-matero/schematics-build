...
function addKeyPkgsToPackageJson(host) {
    package_config_1.addPackage(host, '@angular/cdk@~8.2.1');
...
function add3rdPkgsToPackageJson(host, options) {
    package_config_1.addPackage(host, '@angular/material@~8.2.1');
    package_config_1.addPackage(host, '@angular/flex-layout@~8.0.0-beta.27');
    if (options.gestures) {
        package_config_1.addPackage(host, 'hammerjs@^2.0.8');
    }
    // 3rd lib
    package_config_1.addPackage(host, '@ng-matero/extensions@^0.4.0');
    package_config_1.addPackage(host, '@ng-select/ng-select@^3.6.1');
    package_config_1.addPackage(host, '@ngx-formly/core@^5.5.5');
    package_config_1.addPackage(host, '@ngx-formly/material@^5.5.5');
    ...
    package_config_1.addPackage(host, 'ngx-toastr@^11.2.1');
