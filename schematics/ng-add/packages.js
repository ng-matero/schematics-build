...
function add3rdPkgsToPackageJson(host, options) {
    ...
    // 3rd lib
    package_config_1.addPackage(host, '@ngx-formly/core@^5.4.3');
    package_config_1.addPackage(host, '@ngx-formly/material@^5.4.3');
    ...
    package_config_1.addPackage(host, '@ng-select/ng-select@^3.0.7');
    package_config_1.addPackage(host, 'ngx-toastr@^11.1.0');
